...
import CheckComponent from "@/components/CheckMail";
import ReportFraud from "@/components/ReportFraud";
import Navbar from "@/components/Navbar";

export default function Home() {
  return (
    <div className="min-h-screen bg-blue-100 font-sans leading-normal tracking-normal flex flex-col">
      <main className="container mx-auto px-4 pt-16 pb-12">
        <Navbar/>
        <div className="mb-8">
          <h2 className="text-2xl font-bold mb-4">Type here the Email or link url to see if it is safe or it is a threat</h2>
          <CheckComponent />
        </div>
        <h2 className="text-2xl font-bold mb-4">Report Suspicious Activity: Shield the Community ️</h2>
        <div className="mb-8">
          <ReportFraud />
        </div>
      </main>
    ...
    <div className="container flex flex-col items-center justify-between p-6 mx-auto space-y-4 sm:space-y-0 sm:flex-row">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300">&copy; {new Date().getFullYear()}  All Rights Reserved.</p>
